...
<div class="form-group col-sm-12">
    ...
    {!! Form::text('template_name', null, ['class' => 'form-control','required'=>'required', 'placeholder'=>'Enter the Template name For your Reference']) !!}
</div>
    ...
    <select name="category" class="form-control">
        @php
          ...
          foreach ($get_category as $key => $value) {
                   echo '<option  value="'.$value->category.'">'.$i.'.'.$value->category.'</option>';
                   $i=$i+1;
          }
        @endphp
    </select>
...
<div class="form-group col-sm-12">
    ...
    {!! Form::text('subject', null, ['class' => 'form-control','placeholder'=>'Subject of the Mail' ,'required'=>'required']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    {!! Form::text('attachment_path', "", ['class' => 'form-control', 'placeholder'=>'Just give the filename', 'required'=>'required']) !!}
